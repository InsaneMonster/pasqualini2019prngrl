...
class VPGRNGDiscreteAgent(Agent):
    """
    Vanilla Policy Gradient agent for random number generation discrete environment.
    """
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(VPGRNGDiscreteAgent, self).__init__(name)
